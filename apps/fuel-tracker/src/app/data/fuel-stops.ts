...
export function calculateStateStats(): StateStats[] {
  ...
  const stateData: Map<
    string,
    { stops: number; gallons: number; cost: number; entryOdometer: number; exitOdometer: number }
  > = new Map();
